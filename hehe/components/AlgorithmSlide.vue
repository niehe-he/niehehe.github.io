...
.theme-desert .code-window pre { padding: 0.3vh 0.8vw; height: calc(100% - 13px); }
.theme-orange .code-window pre, .theme-teal .code-window pre, .theme-purple .code-window pre { padding: 0.3vh 0.8vw; height: calc(100% - 16px); }
.theme-pink .code-window pre { padding: 0.8vh 1.2vw; height: calc(100% - 36px); }
